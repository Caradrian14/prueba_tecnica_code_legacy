...
class CuponDescuento10Euro extends Cupon {
    /**
     * Funcion simple que solo hace que restar 10 euro al precio. Esta clase se ha creado deido a que, aunque en la prueba es sencilla,
     ...
     * @return float $final_subtotal - 10.00
     */
