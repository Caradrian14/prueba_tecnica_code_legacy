...
class CuponDescuento2Euro extends Cupon {
    /**
     * Funcion simple que solo hace que restar 2 euro al precio. Esta clase se ha creado deido a que, aunque en la prueba es sencilla,
     ...
     * @return float $final_subtotal - 2.00
     */
